...
To have a local copy of the project to work on clone the repository using the command `git clone https://github.com/Daniija/TradeSwap-Backend.git` in the terminal.
